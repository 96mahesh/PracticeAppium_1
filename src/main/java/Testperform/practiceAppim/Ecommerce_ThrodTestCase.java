...
public class Ecommerce_ThrodTestCase extends BaseTest {
...
//		}
	...
	public void fillForm() throws InterruptedException {
		...
		Thread.sleep(3000);
//		boolean googleLogo = driver.findElement(By.xpath("//img[@class='lnXdpd']")).isDisplayed();
//		Assert.assertTrue(googleLogo, "Test Failed");
		driver.findElement(By.name("q")).sendKeys("power star images");
